...
class SellerRatingControllerTest {
    ...
    private static final User CURRENT_USER = User.builder()
            .id(2L).username("buyer").role(Role.USER).build();
    ...
    void rateAdvertisement_shouldReturn201_whenDataIsValid() throws Exception {
        SellerRatingRequest request = SellerRatingRequest.builder().rating(5).comment("عالی بود").build();
    ...
    void rateAdvertisement_shouldReturn400_whenRatingIsAboveFive() throws Exception {
        SellerRatingRequest request = SellerRatingRequest.builder().rating(6).build();
    ...
    void rateAdvertisement_shouldReturn400_whenRatingIsBelowOne() throws Exception {
        SellerRatingRequest request = SellerRatingRequest.builder().rating(0).build();
    ...
    @Test
    void rateAdvertisement_shouldReturn400_whenRatingIsNegative() throws Exception {
        SellerRatingRequest request = SellerRatingRequest.builder().rating(-1).build();
    ...
    void rateAdvertisement_shouldReturn400_whenRatingIsMissing() throws Exception {
        SellerRatingRequest request = SellerRatingRequest.builder().comment("بدون امتیاز").build();
