...
class JwtAuthenticationFilterTest {
    ...
    @Test
    void doFilterInternal_shouldAuthenticate_whenTokenIsValidAndUserExists() throws ServletException, IOException {
        MockHttpServletRequest request = new MockHttpServletRequest();
    ...
    void doFilterInternal_shouldNotAuthenticate_whenValidateTokenReturnsFalse() throws ServletException, IOException {
        ...
        User user = User.builder().id(1L).username("ali123").role(Role.USER).build();
